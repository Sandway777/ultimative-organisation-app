...
Erst mehrere Design-Richtungen zum Vergleichen (je Handy **und** Desktop),
danach – wenn eine gewählt ist – eine **Design-Spec als Textdatei**:
Token-Tabelle plus Komponentenregeln in Worten. Details am Ende von
`00-UEBERSICHT.md`.
